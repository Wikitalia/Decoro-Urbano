...
/**
 * Chiamata AJAX per eliminare un commento dalla lista dei commenti
 * 
 * @param int id id del commento da cancellare
 */
session_start();
...
// se l'utente non è loggato esci
if (!$user) {
    echo "0";
    exit;
}
...
if (!checkNumericField($id) || !commento_delete($id, $id_utente)) {
    echo "0";
} else {
    echo "1";
}
