...
/**
 * Chiamata AJAX per verifica l'esistenza di un email nel database dell'utenti
 * 
 * @param string e indirizzo email di cui verificare l'esistenza
 */
